...
(which draws ±2 SE) and `gratia::draw()`. Until version 0.10.0 this package drew
±1 SE — roughly 68%, half the width of both, and a width most readers would
assume was 95%. Pass `interval = "se"` for that narrower band, or
`interval = "simultaneous"` on a GAM smooth for a band covering the whole
curve.
