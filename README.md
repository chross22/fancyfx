...
Two caveats the functions state in their own documentation, worth
repeating: AUC and TSS are defined for **binary outcomes only** and a
continuous response is refused rather than scored; and permutation
importance **splits credit badly between correlated predictors**, which
bites hard on environmental covariates.
